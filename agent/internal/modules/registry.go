...
func Init() error {
	...
	// Register new Windows artifacts (BITS, WMI, ScriptBlock, hosts, NIC, Defender exclusions, Timeline, etc.)
	Register(NewWindowsEventLogBITS())
	Register(NewWindowsEventLogWMIActivity())
	Register(NewWindowsEventLogPSScriptBlock())
	Register(NewWindowsHostsFile())
	Register(NewWindowsNetworkInterfaces())
	Register(NewWindowsDefenderExclusions())
	Register(NewWindowsTimeline())
	Register(NewWindowsAppCompatShims())
	Register(NewWindowsInstalledSoftware())
	Register(NewWindowsProcessTree())
	Register(NewWindowsActiveConnections())
	Register(NewWindowsNTDS())
	Register(NewWindowsNetLogon())
	Register(NewWindowsIFEO())
	...
	// Register new Linux artifacts (user crontabs, shell configs, firewall, lastlog, SSH keys, etc.)
	Register(NewLinuxUserCrontabs())
	Register(NewLinuxUserShellConfigs())
	Register(NewLinuxIPTables())
	Register(NewLinuxLastLog())
	Register(NewLinuxSSHKeys())
	Register(NewLinuxNetworkConfig())
	Register(NewLinuxSetuidBinaries())
	Register(NewLinuxProcNet())
	Register(NewLinuxInitScripts())
	Register(NewLinuxAtJobs())
	Register(NewLinuxPackageHistory())
	Register(NewLinuxProfileD())
	Register(NewLinuxSystemdOverrides())

	// Register macOS modules
	Register(NewMacOSProcessList())
	Register(NewMacOSNetworkConnections())
	Register(NewMacOSUnifiedLog())
	Register(NewMacOSInstallLog())
	Register(NewMacOSLaunchdAgents())
	Register(NewMacOSLaunchdDaemons())
	Register(NewMacOSLoginItems())
	Register(NewMacOSCron())
	Register(NewMacOSSystemInfo())
	Register(NewMacOSUsers())
	Register(NewMacOSBashHistory())
	Register(NewMacOSZshHistory())
	Register(NewMacOSInstalledApps())
	Register(NewMacOSSafariHistory())
	Register(NewMacOSChromeHistory())
	Register(NewMacOSQuarantineEvents())
	Register(NewMacOSSSHKnownHosts())
